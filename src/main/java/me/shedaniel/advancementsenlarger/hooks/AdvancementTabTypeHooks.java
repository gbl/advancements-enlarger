...
public interface AdvancementTabTypeHooks {
    void ae_drawBackground(MatrixStack stack, DrawableHelper drawable, int x, int y, boolean selected, int index);
    
    void ae_drawIcon(MatrixStack stack, int x, int y, int index, ItemRenderer itemRenderer, ItemStack icon);
